    ...
    list.forEach(initiative => {
        ...
        initiativeElement.innerHTML = `
            ...
            <div class="initiative-details">
                ...
                <div class="details-section">
                    <h4><i class="fas fa-bullseye"></i> Resultados Esperados</h4>
                ...
                <div class="details-section">
                    <h4><i class="fas fa-tasks"></i> Metas</h4>
                    <ul class="details-list">
                        ${initiative.Metas.map((meta, index) => `
                            <li>
                                <div class="meta-item">
                                    <div class="meta-header">
                                        ...
                                        <div class="meta-info">
                                            ...
                                            <span class="meta-status ${getMetaStatusClass(meta.status)}">${meta.status}</span>
                                        </div>
                                    </div>
                                    <div class="meta-progress">
                                        <div class="meta-progress-value" style="width: ${meta.progresso}%"></div>
                                    </div>
                                    <div class="meta-actions">
                                        <button class="btn btn-sm btn-outline edit-meta-btn" data-initiative="${initiative.Iniciativas}" data-meta-index="${index}">
        ...
        editMetaBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                openEditMetaModal(initiativeName, metaIndex);
            });
        });
    });
}
...
function openEditMetaModal(initiativeName, metaIndex) {
    const editMetaModal = document.getElementById('editMetaModal');
    currentInitiative = initiatives.find(i => i.Iniciativas === initiativeName);
    currentMetaIndex = metaIndex;
    
    if (!currentInitiative || !currentInitiative.Metas || !currentInitiative.Metas[metaIndex]) return;
    
    const meta = currentInitiative.Metas[metaIndex];
...
function saveMetaEdit() {
    if (!currentInitiative || currentMetaIndex === null) return;
    
    // Atualizar a meta
    currentInitiative.Metas[currentMetaIndex] = {
        ...currentInitiative.Metas[currentMetaIndex],
